...
To finish, some scripts may be provided with the library **physLP** :doc:`(see Reference Guide) <scripts>`.
To use them, you can just download `scripts source codes <https://github.com/LancelotPincet/physLP/tree/main/src/physlp/scripts>`_.
