...
- The library is organized under `src/physlp` into two main parts:
...
- The main object is defined in:
  - `myname.py`
  - and imported as: `from physlp import myname`
...
- All such objects become importable from the package root directly with ```from physlp import myname```.
